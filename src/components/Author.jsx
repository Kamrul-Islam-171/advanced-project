            ...
            <div className="flex flex-col justify-center w-full shadow-md rounded-xl sm:px-12  ">
                ...
                <div className="space-y-4 text-center divide-y divide-gray-700">
                    ...
                    <div className="flex justify-center pt-2 space-x-4 align-center">
                        <a target="blank" href={`http://github.com/${github_username}`} aria-label="GitHub" className="p-2 rounded-md  hover:text-violet-400">
                        ...
                        <a target="blank" href={website_url} aria-label="Dribble" className="p-2 rounded-md  hover:text-violet-400">
                        ...
                        <a target="blank" href={`http://twitter.com/${twitter_username}`} aria-label="Twitter" className="p-2 rounded-md  hover:text-violet-400">
                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
